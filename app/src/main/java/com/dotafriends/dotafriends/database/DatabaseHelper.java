...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public Void insertMatch(SingleMatchInfo match) throws SQLException{
        Log.d(TAG, "Inserting match");
        ...
        try {
            ...
            values.put(DatabaseContract.MatchInfo.TOWER_STATUS_RADIANT,
                    match.getTowerStatusRadiant());
            values.put(DatabaseContract.MatchInfo.TOWER_STATUS_DIRE, match.getTowerStatusDire());
            values.put(DatabaseContract.MatchInfo.BARRACKS_STATUS_RADIANT,
                    match.getBarracksStatusRadiant());
            values.put(DatabaseContract.MatchInfo.BARRACKS_STATUS_DIRE,
                    match.getBarracksStatusDire());
            ...
            for (PlayerMatchData player : match.getPlayers()) {
                ...
                values.put(DatabaseContract.PlayerMatchData.LEAVER_STATUS,
                        player.getLeaverStatus());
                ...
                if (player.getAbilityUpgrades() != null) {
                    ...
                    for (AbilityUpgrade ability : player.getAbilityUpgrades()) {
                        ...
                        values.put(DatabaseContract.AbilityUpgrades.PLAYER_SLOT,
    ...
    public Void insertPlayerSummary(PlayerSummary playerSummary) throws SQLException {
        Log.d(TAG, "Inserting player summary");
        SQLiteDatabase db = getWritableDatabase();
        db.beginTransaction();
        try {
            db.execSQL("INSERT OR IGNORE INTO " + DatabaseContract.Players.TABLE_NAME +
